...
export const categorizedBookmarks = [
  {
    category: '🧪 开发工具',
    items: [
      { title: 'GS', url: 'https://grep.app/' },
      { title: 'm3u8 downloader', url: 'http://blog.luckly-mjw.cn/tool-show/m3u8-downloader/index.html' },
      { title: '帮小忙', url: 'https://tool.browser.qq.com/' },
      { title: 'Table Convert Online', url: 'https://tableconvert.com/json-to-excel' },
      { title: 'CloudConvert', url: 'https://cloudconvert.com/' },
  ...
  },
  {
    category: '💰 金融投资',
    items: [
      { title: '复盘网', url: 'https://www.fupanwang.com/' },
      { title: '打板客', url: 'https://www.dabanke.com/' },
      { title: '国债', url: 'https://www.chinamoney.com.cn/chinese/sddsintigy/' },
      { title: '存款利率', url: 'https://bank.cngold.org/yhckll/' },
      { title: '黄金行情', url: 'https://quote.cngold.org/gjs/jjs_hj9999.html' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Animagraffs', url: 'https://animagraffs.com/' }
    ]
  },
  {
    category: '🌍 生活服务',
  ...
  },
  {
    category: '🔒 安全研究',
    items: [
      { title: '先知社区', url: 'https://xz.aliyun.com/' },
      { title: '安全客', url: 'https://www.anquanke.com/' },
      { title: '跳跳糖', url: 'https://tttang.com/' },
      { title: 'OWASP Attacks', url: 'https://owasp.org/www-community/attacks/' },
      { title: '0kami', url: 'https://blog.0kami.cn/' },
      { title: 'JNDI注入利用', url: 'https://mp.weixin.qq.com/s/Dq1CPbUDLKH2IN0NA_nBDA' },
      { title: 'Installing Xray - JFrog', url: 'https://www.jfrog.com/confluence/display/JFROG/Installing+Xray' },
      { title: '站点安全 - MDN', url: 'https://developer.mozilla.org/zh-CN/docs/learn/Server-side/First_steps/Website_security' },
      { title: 'HTTP CORS - MDN', url: 'https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Access_control_CORS' },
      { title: '数据库内核', url: 'http://mysql.taobao.org/monthly/' }
    ]
  },
  {
    category: '🌐 其他',
